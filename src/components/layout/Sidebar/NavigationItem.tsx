  ...
  return (
    ...
    >
      {/* 
        ...
        Using tabIndex={-1} on all routes that are not implemented to prevent keyboard navigation
        on those elements.
      */}
      <a
        href={href}
        tabIndex={href === "/" ? 0 : -1}
        className="pointer-events-none flex h-11 w-full items-center gap-2 px-8 py-3"
      >
